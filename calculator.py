...
class Calculator(ctk.CTk):
	...
	def clear(self): #! A/C clear button function
		self.formula_string.set('')
		self.result_string.set(0)
		self.display_nums.clear()


	def percent(self): #! convert input/result to percent
	...
	def invert(self): #! pos -> neg and vice versa
	...
	def num_press(self, value):	#! value here is the actual number, displays number input
		self.display_nums.append(str(value)) #! appends input to a list
		full_number = ''.join(self.display_nums) #! joins the numbers in the list
	...
	def math_press(self, value): #! value here is the operation such as * for multiplication, 
		...
		if current_number:
			...
			if value != '=': #! i.e all other math operations
